...
from sqlalchemy import DateTime, Enum as SqlEnum, ForeignKey, Identity, Integer, Text, func
...
class IngestionJob(Base):
    ...
    document_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("ai.knowledge_documents.id", ondelete="CASCADE"), nullable=False
    )
