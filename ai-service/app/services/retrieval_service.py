...
class RetrievalService:
    ...
    def search(self, db: Session, *, query: str, top_k: int | None = None, similarity_threshold: float | None = None) -> list[RetrievedChunkResponse]:
        ...
        return self.chunk_repository.search_similar(db, query_embedding=query_embedding, top_k=resolved_top_k, similarity_threshold=resolved_similarity_threshold)
