...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDisabled(DisabledException exception, WebRequest request) {

        return build(HttpStatus.UNAUTHORIZED, "Tài khoản đã bị khóa", request);
    }
